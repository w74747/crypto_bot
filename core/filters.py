...
def calculate_fibonacci_targets_v2(
    ...
    """
    للـ RSI < 31 (Oversold Rebound):
    الأهداف داخل النطاق بين القاع والقمة
    TP1 = 0.382 | TP2 = 0.500 | TP3 = 0.618
    ...
    if rsi < 31:
        # RSI Oversold Rebound — أهداف داخلية
    ...
    # الأهداف يجب أن تكون فوق السعر الحالي
