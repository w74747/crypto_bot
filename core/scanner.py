...
class MarketScanner:
    ...
    def passes_filters(self, symbol: str, ind: dict, volume_usd: float) -> tuple[bool, str]:
        ...
        # استراتيجية D (جديدة): تذبذب محلي — Scalping
        if crash_60d >= 0.10 and crash_60d < 0.40 and rsi < 40 and stabilizing:
    ...
    def _process_symbol(self, symbol: str) -> Optional[TradeOpportunity]:
        ...
        # جلب الفريمات الإضافية للأهداف الديناميكية
